...
def database_original():
    connection = QSqlDatabase.addDatabase("QSQLITE")
    connection.setDatabaseName("VegetablesFruitsDatabaseOriginal.db")
...
def vegetables_and_fruits_load_original(vegetable_or_fruit_id):
    query = QSqlQuery('SELECT * FROM vegetables_and_fruits WHERE vegetable_or_fruit_id = ?')
